#### php -c /etc/php/cli-php7.2/php.ini -f index.php

##### Include Path: .:/usr/share/php7:/usr/share/php
...
+ is_readable("config/test.php"): false
+ is_readable("./config/test.php"): false
...
+ is_writeable("./config/test.php"): false
+ is_writeable("../config/test.php"): true
...
#### php -dphar.readonly=0 -f index.php                                       
